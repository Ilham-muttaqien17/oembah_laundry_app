    ...
    <body>
        <div class="flex flex-row">
            ...
            <main class="w-full bg-gray-soft ml-[3.7rem] h-screen px-2 overflow-y-scroll">
                <div class="flex my-8">
                    <h1 class="mx-auto text-dark-blue font-bold text-xl lg:text-2xl">ON DELIVERY</h1>
                </div>
                ...
                <div class="flex flex-col gap-y-4 py-4 w-11/12 mx-auto text-sm lg:text-base">
                    <div class="flex items-center gap-x-2">
                        ...
                        <p class="text-dark-blue font-semibold">Terdapat <?= sizeof($deliveryOrder); ?> order yang sedang dalam pengiriman</p>
                    </div>
                    ...
                    <?php if($row['status'] == 'On Delivery') : ?>
                        <div class="bg-dark-blue p-4 rounded-xl flex flex-col gap-y-4 text-xs md:text-sm lg:text-base">
                            <div class="bg-white p-2 text-dark-blue font-semibold rounded-lg">
