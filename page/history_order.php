...
$order = query("SELECT * FROM tb_order 
                ...
                INNER JOIN tb_laundry ON tb_order.id_laundry = tb_laundry.id_laundry WHERE tb_transaksi.status_transaksi = 'Success'");
?>
...
<html lang="en">
    ...
    <body class="bg-gray-soft">
        ...
        <div class="w-10/12 md:w-8/12 mx-auto mt-10 mb-20">
            <h1 class="text-dark-blue font-bold text-xl mb-10">Riwayat transaksi</h1>
            <div class="flex flex-col w-full gap-y-4">
                <?php                
                    if(sizeof($order) < 1) {
                        echo "<div class='h-[220px] text-dark-blue text-sm'>Tidak ada transaksi yang berhasil</div>";
                    } else { 
                ...
                ?>
                    ...
                    <div class="border p-4 rounded-xl shadow">
                        <div class="flex flex-col gap-x-4 gap-y-2 sm:flex-row sm:items-center">
                            ...
                            <p class="text-white font-semibold bg-green-600 rounded text-xs w-[150px] text-center"><?= $row['status_transaksi'] ?></p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-4 mt-6 justify-end">
                            <a class="px-4 py-1 border border-gray-400 rounded flex items-center gap-x-2" href="https://wa.me/<?= $row["kontak"]?>">
                                <img src="../img/icons/whatsapp_icon.svg" alt="Whatsapp Icon" />
                                <span class="text-dark-blue font-semibold">Chat penjual</span>
                            </a>
                        </div>
                    </div>
